    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUser", x => x.NationalCode);
                    table.ForeignKey(
                        name: "FK_ApplicationUser_Persons_NationalCode",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserNationalCode = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationRole", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationRole_ApplicationUser_ApplicationUserNationalCode",
                        column: x => x.ApplicationUserNationalCode,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WoundCares_ApplicationUser_UserId",
                        column: x => x.UserId,
                        principalTable: "ApplicationUser",
                        principalColumn: "NationalCode");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRole_ApplicationUserNationalCode",
                table: "ApplicationRole",
                column: "ApplicationUserNationalCode");
